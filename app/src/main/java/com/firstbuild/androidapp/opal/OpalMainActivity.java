            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_item_diagnostics:
                        BleManager.getInstance().readCharacteristics(opalInfo.bluetoothDevice, OpalValues.OpalLogIndex);
                        BleManager.getInstance().readCharacteristics(opalInfo.bluetoothDevice, OpalValues.OpalLog0);
                        BleManager.getInstance().readCharacteristics(opalInfo.bluetoothDevice, OpalValues.OpalLog1);
                        BleManager.getInstance().readCharacteristics(opalInfo.bluetoothDevice, OpalValues.OpalLog2);
                        BleManager.getInstance().readCharacteristics(opalInfo.bluetoothDevice, OpalValues.OpalLog3);
                        BleManager.getInstance().readCharacteristics(opalInfo.bluetoothDevice, OpalValues.OpalLog4);
                        BleManager.getInstance().readCharacteristics(opalInfo.bluetoothDevice, OpalValues.OpalLog5);
                        BleManager.getInstance().readCharacteristics(opalInfo.bluetoothDevice, OpalValues.OpalLog6);
                        break;
